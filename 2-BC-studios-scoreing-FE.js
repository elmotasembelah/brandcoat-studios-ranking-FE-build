  ...
  lt = (e) => {
    ...
    return (
      ...
      ((typeof FormData == "function" && e instanceof FormData) ||
        (x(e.append) &&
          ((t = v(e)) === "formdata" || // detect form-data instance
            (t === "object" &&
              x(e.toString) &&
              e.toString() === "[object FormData]"))))
    );
  },
  ut = C("URLSearchParams"),
  [ft, dt, pt, ht] = ["ReadableStream", "Request", "Response", "Headers"].map(
    C
  ),
  mt = (e) =>
...
const Ut = (e) => {
  ...
  Dt = C("AsyncFunction"),
  kt = (e) => e && (K(e) || x(e)) && x(e.then) && x(e.catch),
  De = ((e, t) =>
    e
      ? setImmediate
      : t
  ...
  qt =
    typeof queueMicrotask < "u"
      ...
      : (typeof process < "u" && process.nextTick) || De,
  a = {
    isArray: D,
    isArrayBuffer: Ne,
    isBuffer: et,
  ...
  function u(p, y, h) {
    ...
    if (p && !h && typeof p == "object") {
      if (a.endsWith(y, "{}"))
        ...
        (a.isArray(p) && It(p)) ||
        ((a.isFileList(p) || a.endsWith(y, "[]")) && (w = a.toArray(p)))
      )
        return (
          (y = je(y)),
      ...
      d.push(p),
        a.forEach(p, function (w, g) {
          (!(a.isUndefined(w) || w === null) &&
            s.call(t, w, a.isString(g) ? g.trim() : g, y, b)) === !0 &&
            S(w, y ? y.concat(g) : [g]);
        }),
        d.pop();
    }
...
function He(e, t, n) {
  ...
  if (
    (s
      ? (o = s(t, n))
      : (o = a.isURLSearchParams(t) ? t.toString() : new le(t, n).toString(r)),
    o)
  ) {
    const i = e.indexOf("#");
    i !== -1 && (e = e.slice(0, i)),
...
const Me = {
  ...
  zt = typeof URLSearchParams < "u" ? URLSearchParams : le,
  Jt = typeof FormData < "u" ? FormData : null,
    ...
    return (
      ...
      f
        ...
        : ((!s[i] || !a.isObject(s[i])) && (s[i] = []),
          t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = Zt(s[i])),
          !c)
    );
  }
...
class A {
  ...
  set(t, n, r) {
    ...
    else if (a.isString(t) && (t = t.trim()) && !rn(t)) i(tn(t), n);
...
function U(e, t) {
  ...
  function s(l, u, d) {
    if (a.isUndefined(u)) {
      if (!a.isUndefined(l)) return r(void 0, l, d);
    } else return r(l, u, d);
  }
  function o(l, u) {
...
const ve = (e) => {
    ...
    (t.headers = i = A.from(i)),
      (t.url = He($e(t.baseURL, t.url), e.params, e.paramsSerializer)),
      c &&
        i.set(
          "Authorization",
          "Basic " +
    ...
    if (
      ...
      (r && a.isFunction(r) && (r = r(t)), r || (r !== !1 && un(t.url)))
    ) {
      ...
      return new Promise(function (n, r) {
        ...
        "onloadend" in h
          ...
          "setRequestHeader" in h &&
            a.forEach(i.toJSON(), function (P, T) {
    ...
    if (t || n) {
      ...
      const o = function (l) {
        if (!s) {
          ...
          r.abort(
            u instanceof m ? u : new k(u instanceof Error ? u.message : u)
          );
        }
      };
      let i =
  ...
  We = X && typeof ReadableStream == "function",
  Sn =
    X &&
  ...
  Oe = 64 * 1024,
  se = We && Ke(() => a.isReadableStream(new Response("").body)),
  $ = {
    stream: se && ((e) => e.body),
  };
X &&
...
const Rn = async (e) => {
  ...
  On =
    ...
    (async (e) => {
      ...
      let S = yn([s, o && o.toAbortSignal()], i),
        p;
      const y =
        S &&
        S.unsubscribe &&
  ...
  Ge = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !An(n) && ((r = oe[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
const Nn = async (e, t = "") => {
  ...
  Fn = "https://www.brandcoat.net/creator/",
  _n = async (e = "") => {
    const { studioScores: t } = await Nn("formula1", e),
      n = document.querySelector("#formula1_result_wrapper");
    Array.from(n.querySelectorAll("div")).forEach((s, o) => {
      const i = s.querySelector("#name"),
        c = s.querySelector("#studio_link"),
        f = s.querySelector("#logo"),
        l = s.querySelector("#total");
      (i.innerText = t[o].name),
        (c.href = Fn + t[o].slug),
        (f.src = t[o].logoUrl),
        (l.innerText = t[o].total);
    });
  };
function Ln(e) {
  return e.includes("Cafes & Bistros") !== -1
    ? e.replace("Cafes & Bistros", "Cafes and Bistros")
    : e.includes("F & B") !== -1
    ? e.replace("F & B", "F and B")
    : e;
}
const Bn = ["Industry", "Geographics", "Generations"],
  Un = () => {
    const e = Dn();
    let t = "";
    for (const r in e) {
...
function kn(e) {
  ...
  return (
    t.forEach((r) => {
      r.checked &&
        (n.length === 0
          ? (n += r.nextElementSibling.textContent)
          : (n += "-" + r.nextElementSibling.textContent));
    }),
    n
  );
...
const jn = (e, t = "block") => {
  ...
  Hn = async () => {
    const e = Un();
    e
      ? (jn("formula1_result_wrapper", "flex"), In(e))
      : alert(
          "Please set at least one filter to find the best matched studios."
        );
  },
  Mn = () => {
